...
public final class InactivityTimer {
	...
	public synchronized void onPause() {
		...
		if (registered) {
			...
			Timber.tag(TAG).w("PowerStatusReceiver was never registered?");
		}
	}

	public synchronized void onResume() {
		if (registered) {
			Timber.tag(TAG).w("PowerStatusReceiver was already registered?");
		} else {
	...
	private final class InactivityAsyncTask extends
		...
		protected Object doInBackground(Object... objects) {
			try {
				...
				Timber.tag(TAG).i("Finishing activity due to inactivity");
				activity.finish();
