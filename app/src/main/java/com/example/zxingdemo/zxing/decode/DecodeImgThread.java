package com.example.zxingdemo.zxing.decode;
...
public class DecodeImgThread extends Thread {
    ...
    /*回调*/
    private final DecodeImgCallback callback;
    ...
    public void run() {
        ...
        Bitmap scanBitmap = getBitmap(imgPath);
        ...
        try {
            ...
            Timber.tag("解析结果").i(rawResult.getText());
     ...
     * @return bitmap
     */
    private static Bitmap getBitmap(final String filePath) {
